  ...
  return (
    <div className="fixed bottom-4 left-1/2 z-40 flex w-[calc(100%-2rem)] max-w-md -translate-x-1/2 items-center gap-3 rounded-xl bg-slate-900 px-4 py-3 text-sm text-white shadow-2xl dark:bg-neutral-100 dark:text-neutral-900">
      ...
      <button
        ...
        className="shrink-0 rounded-lg bg-white px-3 py-1.5 text-xs font-medium text-slate-900 hover:bg-slate-100 dark:bg-neutral-900 dark:text-neutral-100 dark:hover:bg-neutral-800"
      >
        Instalar
      </button>
      <button
        ...
        className="shrink-0 text-white/70 hover:text-white dark:text-neutral-900/60 dark:hover:text-neutral-900"
      >
        ✕
      </button>
    </div>
